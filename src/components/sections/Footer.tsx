...
const Footer = () => {
    return (
        <footer className="w-full min-w-[375px] text-neutral-300 px-[20px] pt-[20px]">
            <div className="max-w-[1920px] xxxl:mx-auto mx-auto bg-neutral-900 rounded-t-[12px] px-[20px] py-[60px] xxl:p-[80px]">

...
const FAQSection: React.FC<FAQSectionProps> = ({ eyebrow, heading, subheading, cta, items, defaultOpen }) => {
    ...
    return (
        <section className="max-w-[1440px] xxxl:mx-auto flex flex-col xxl:flex-row xxl:justify-start gap-[80px] w-full min-w-[375px] bg-white px-[40px] xxl:px-[80px] pt-0 xxl:pt-[120px] pb-[60px]">

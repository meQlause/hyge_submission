    ...
    return (
        <section className="max-w-[1920px]  xxxl:mx-auto flex flex-col lg2:flex-row lg2:gap-[300px] w-full min-w-[375px] px-[40px] xxl:px-[80px] text-black bg-white my-[120px] justify-between">
            <div className="flex flex-col gap-[4px]">
                ...
                <h2 className="text-[40px] xxl:text-[48px] xxl:max-w-[300px] font-[500] mb-[80px]">Home Improvement Specialists</h2>
            </div>
            <p className="w-full lg2:max-w-[432px] xxl:text-[20px] xxl:max-w-[600px] text-[18px] font-[400] leading-[170%] -tracking-[0.3px] text-[#3D3D47] ">
